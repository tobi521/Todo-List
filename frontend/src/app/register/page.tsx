    ...
    <ProtectedRoute>
      <section className="text-gray-600 body-font w-full bg-gray-100 h-screen">
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="text-center mt-8 text-4xl mb-20">Register</div>
          <div className="flex flex-col text-center mb-20 mt-10 justify-self-center">
            <input className="w-100 bg-white rounded border 
              ...
              leading-8 transition-colors duration-200 ease-in-out mr-2 my-2" type="text" placeholder="Name"
              name="name"
            ...
            <input className="w-100 bg-white rounded border 
              ...
              focus:ring-2 focus:ring-green-200 text-base 
              outline-none text-gray-700 py-3 px-3
              leading-8 transition-colors duration-200 ease-in-out mr-2 my-2" type="password" placeholder="Confirm Password"
              name="confirmPassword"
              onChange={(e:any) => handleChange(e)}
            />
            <button className="bg-gray-500 rounded hover:bg-gray-600 text-white py-3 px-4 focus:ring-2 focus:ring-gray-200 mt-4" onClick={(e:any) => handleSubmit(e)}>Register</button>
          </div>
        </div>
      </section>
    </ProtectedRoute>
